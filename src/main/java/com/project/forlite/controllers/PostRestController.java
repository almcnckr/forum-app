...
public class PostRestController {
    ...
    @PostMapping
    public GetPostResponse createPost(@RequestBody CreatePostRequest createPostRequest){
        return postService.createPost(createPostRequest);
    }

    @PutMapping
    public GetPostResponse updatePost(@RequestBody UpdatePostRequest updatePostRequest){
